...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("Результат: " + Stack1.game(firstPlayerS, secondPlayerS) + "\n\n");
        ...
        System.out.println("Результат: " + Queue1.game(firstPlayerQ, secondPlayerQ) + "\n\n");
        ...
        System.out.println("Результат: " + Dequeue.game(firstPlayerDeq, secondPlayerDeq) + "\n\n");
        ...
        System.out.println("Результат: " + DoubleList.game(firstPlayerDl, secondPlayerDl) + "\n\n");
    }
}